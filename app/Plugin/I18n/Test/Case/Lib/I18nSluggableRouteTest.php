...
class I18nSluggableRouteTestCase extends CakeTestCase {
    ...
    public function testMatchBasic() {
        $route = new I18nSluggableRoute(
                '/users/view/:I18nUser', array('plugin' => null, 'controller' => 'users', 'action' => 'view'), array('models' => array('I18nUser'))
        );
    ...
    public function testParsing() {
        $route = Router::connect(
                        '/users/view/:I18nUser', array('plugin' => null, 'controller' => 'users', 'action' => 'view'), array('routeClass' => 'I18nSluggableRoute', 'models' => array('I18nUser'))
        );
