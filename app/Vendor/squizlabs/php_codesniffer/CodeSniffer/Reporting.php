...
//end cacheFileReport()
    ...
    $report, $showSources, $reportFile = '', $reportWidth = 80
    ) {
        $reportClass = $this->factory($report);
        ...
        $reportClass->generate(
                $reportCache, $this->totalFiles, $this->totalErrors, $this->totalWarnings, $showSources, $reportWidth, $toScreen
        );
            ...
            foreach ($lineWarnings as $column => $colWarnings) {
                ...
                if (isset($errors[$line][$column]) === true) {
                    $errors[$line][$column] = array_merge(
                            $newWarnings, $errors[$line][$column]
                    );
                } else {
