...
//end register()
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
        ...
        $firstContent = $phpcsFile->findNext(
                T_WHITESPACE, ($scopeOpener + 1), null, true
        );
        ...
        if ($firstContent !== $scopeCloser) {
            $lastContent = $phpcsFile->findPrevious(
                    T_WHITESPACE, ($scopeCloser - 1), null, true
            );
        ...
        if ($tokens[$trailingContent]['code'] === T_COMMENT) {
            ...
            $nextCode = $phpcsFile->findNext(
                    PHP_CodeSniffer_Tokens::$emptyTokens, ($scopeCloser + 1), null, true
            );
        ...
        } else if ($tokens[$trailingContent]['code'] !== T_ELSE && $tokens[$trailingContent]['code'] !== T_ELSEIF && $tokens[$trailingContent]['line'] === ($tokens[$scopeCloser]['line'] + 1)
        ) {
