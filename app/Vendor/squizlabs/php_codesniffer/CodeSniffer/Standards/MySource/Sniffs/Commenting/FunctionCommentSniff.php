    ...
    protected function processUnknownTags($commentStart, $commentEnd) {
        ...
        foreach ($unknownTags as $errorTag) {
            ...
            if ($errorTag['tag'] === 'api') {
                ...
                if (trim($words[($pos - 2)]) !== '' || strpos($words[($pos - 2)], $this->currentFile->eolChar) === false || strpos($words[($pos - 3)], $this->currentFile->eolChar) === false || trim($words[($pos - 4)]) === ''
                ) {
                ...
                if (trim($words[($pos - 2)]) !== '' || strpos($words[($pos - 2)], $this->currentFile->eolChar) === false || trim($words[($pos - 3)]) === ''
                ) {
        ...
        if ($hasApiTag === true) {
            ...
            if ($lastTag !== 'api' && substr($lastTag, 0, 4) !== 'api-'
            ) {
            ...
            foreach ($unknownTags as $errorTag) {
                if ($errorTag['tag'] === 'api' || substr($errorTag['tag'], 0, 4) === 'api-'
                ) {
