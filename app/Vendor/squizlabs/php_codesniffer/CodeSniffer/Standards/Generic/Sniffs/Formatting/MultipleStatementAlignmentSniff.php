...
//end register()
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
        ...
        $nextAssign = $phpcsFile->findNext(
                PHP_CodeSniffer_Tokens::$assignmentTokens, ($lineEnd + 1)
        );
        ...
        while (($prevAssignment = $phpcsFile->findPrevious(PHP_CodeSniffer_Tokens::$assignmentTokens, ($prevAssignment - 1))) !== false) {
            ...
            $nextOpener = $phpcsFile->findNext(
                    PHP_CodeSniffer_Tokens::$scopeOpeners, ($prevAssignment + 1)
            );
        ...
        foreach ($assignments as $assignment) {
            $prev = $phpcsFile->findPrevious(
                    PHP_CodeSniffer_Tokens::$emptyTokens, ($assignment - 1), null, true
            );
